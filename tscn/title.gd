...
const VBOXCONTAINER_ITEM_COUNT = 2
...
func __initiateSelectColor():
	$VBoxContainer/Play.add_theme_color_override("font_color", Color.WHITE)
...
func _select(index : int):
	match index:
		0:
			...
			$VBoxContainer/Play.add_theme_color_override("font_color", Gvar.ACCENT_COLOR)
		1:
			__initiateSelectColor()
